%% DEMDP01B Timber Harvesting Model - Cubic Spline Approximation Using Broyden
%
...
ns = 200;                               % number of collocation nodes
basis  = fundefn('spli',ns,0,smax);     % basis functions
snodes = funnode(basis);                % collocation nodes
