%% NELDMEAD
%
%  Computes local maximum of multivariate function using Nelder-Mead algorithm
%
%  Usage
%    [x,S] = neldmead(f,x,S,varargin)
%  Input
%    f         : function of form fval=f(x,varargin)
%    x         : n.1 initial vector
%    S         : n.(n+1) initial simplex (optional)
%    varargin  : optional parameters passed to f
%  Output
%    x         : n.1 solution vector
%    S         : n.(n+1) ending simplex sorted best to worst (x=S(:,1))
%  Options
