%% DDPSOLVE  
%
%  Solves discrete time discrete state/action dynamic programming model.
%
%  More specifically, computes solution to Bellman equation of 
%  discrete-time dynamic optimization model with discrete state and
%  discrete action.
%
%  Usage
