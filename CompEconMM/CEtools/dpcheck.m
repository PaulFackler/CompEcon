...
function dpcheck(model,s,x,i,j)
...
[f,fx,fxx] = feval(model.func,'f',s,x,i,j,e,model.params{:});
[g,gx,gxx] = feval(model.func,'g',s,x,i,j,e,model.params{:});

fxfd  = fjac(model.func,3,'f',s,x,i,j,e,model.params{:});
gxfd  = fjac(model.func,3,'g',s,x,i,j,e,model.params{:});
fxxfd = fjac(model.func,[3 2],'f',s,x,i,j,e,model.params{:});
gxxfd = fjac(model.func,[3 2],'g',s,x,i,j,e,model.params{:});
